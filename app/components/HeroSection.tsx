    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-xl mx-auto text-center">
            Hello! My name is Alma and I love exploring all about data, systems, and cloud technologies.
          </p>
